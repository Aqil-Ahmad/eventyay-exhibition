...
class ProposalLinkFormsetMixin:
    ...
    def post_with_formsets(self):
        ...
        if (
            form.is_valid()
            and (
                self.social_media_formset is None
                or self.social_media_formset.is_valid()
            )
            and (
                self.extra_links_formset is None or self.extra_links_formset.is_valid()
            )
        ):
